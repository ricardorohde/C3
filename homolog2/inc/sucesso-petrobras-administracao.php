...
<div class="master column detalhesCurso">
   ...
   <div class="tab-pane active" id="inscreva-se">
     ...
     <p><strong class="tit">Prepare-se com os melhores!</strong><br />
       Nossa equipe entrará em contato passando mais informações sobre o Curso PREPARATÓRIO PARA ADMINISTRADOR DA PETROBRÁS.<br />
       <br />
       O C3 Concursos agradece o seu contato.
     </p>
   </div>
 </div>
</div>